...
GPIO_PinConfig gpioPinConfigs[CONFIG_GPIO_COUNT] = {
    ...
    /* CONFIG_GPIO_BUTTON_0 : LaunchPad Button USR_SW1 (Left) */
 ...
 */
extern void hwiFxn(uint_least8_t index);
 ...
 *  ======== pwmMSP432E4Objects ========
 */
PWMMSP432E4_Object pwmMSP432E4Objects[CONFIG_PWM_COUNT];

/*
 *  ======== pwmMSP432E4HWAttrs ========
 */
const PWMMSP432E4_HWAttrs pwmMSP432E4HWAttrs[CONFIG_PWM_COUNT] = {
    /* CONFIG_PWM_0 */
    /* LaunchPad LED D4 */
    {
        ...
        .pinConfig   = PWMMSP432E4_PF0_M0PWM0, /* PF0 */
    },
};
...
const PWM_Config PWM_config[CONFIG_PWM_COUNT] = {
    ...
    /* LaunchPad LED D4 */
    {
        ...
        .object = &pwmMSP432E4Objects[CONFIG_PWM_0],
        .hwAttrs = &pwmMSP432E4HWAttrs[CONFIG_PWM_0]
    },
};
