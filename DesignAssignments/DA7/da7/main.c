...
float Acc_x,Acc_y,Acc_z,Temperature,Gyro_x,Gyro_y,Gyro_z;	// MPU6050 values
float pitch,roll,yaw;										// Derived MPU values
const int period = 5000;									// stepper period
